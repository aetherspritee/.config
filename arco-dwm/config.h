...
static Key keys[] = {
    ...
    {MODKEY, XK_minus, spawn,
     SHCMD("pactl -- set-sink-volume 0 -10%; kill -44 $(pidof dwmblocks)")},
    {MODKEY, XK_plus, spawn,
     SHCMD("pactl -- set-sink-volume 0 +10%; kill -44 $(pidof dwmblocks)")},
    {MODKEY | ShiftMask, XK_equal, setgaps, {.i = 0}},
    /* {MODKEY, XK_p, spawn, SHCMD("pause_play_script")}, */
